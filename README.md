- 검색필터 처리 (이름 닉네임 재난종류 구분) -

<새로만들음>

domain에 DisasterType.java 추가함 (재난종류 구분하는 용도)
